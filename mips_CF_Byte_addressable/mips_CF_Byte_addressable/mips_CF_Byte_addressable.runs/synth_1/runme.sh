...
HD_PWD='E:/STUDY/Books/Electronica/microcontrollers/BITS/Onukr Mutulu Computer Architecture/MIPS_local/MIPS/mips_CF_Byte_addressable/mips_CF_Byte_addressable/mips_CF_Byte_addressable.runs/synth_1'
cd "$HD_PWD"
